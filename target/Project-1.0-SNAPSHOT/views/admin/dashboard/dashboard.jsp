...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <jsp:include page="../../common/admin/logOutModal.jsp"></jsp:include>
            ...
            <!--Add Quiz Modal-->
        <jsp:include page="../../common/admin/addQuizModal.jsp"></jsp:include>
        
            <!--Delete Quiz Modal-->
        <jsp:include page="../../common/admin/deleteQuizModal.jsp"></jsp:include>
        
            <!--Edit Quiz Modal-->
        <jsp:include page="../../common/admin/editQuizModal.jsp"></jsp:include>
